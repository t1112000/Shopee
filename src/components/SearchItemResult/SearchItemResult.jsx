  ...
  return (
    <div>
      <S.SortBar>
        ...
        <S.SortByOptions>
          <S.SortByOptionsOption className={handleActiveOptionSort('view')} onClick={() => sortBy('view')}>
            Phổ biến
          </S.SortByOptionsOption>
          <S.SortByOptionsOption className={handleActiveOptionSort('createdAt')} onClick={() => sortBy('createdAt')}>
            Mới nhất
          </S.SortByOptionsOption>
          <S.SortByOptionsOption className={handleActiveOptionSort('sold')} onClick={() => sortBy('sold')}>
            Bán chạy
          </S.SortByOptionsOption>
          <S.SortByPrice
        ...
        <S.MiniPageController>
          <S.MiniPageControllerState></S.MiniPageControllerState>
